...
class Oligo (models.Model, SaveWithoutHistoricalRecord):
    ...
    synonym = models.CharField("synonym", max_length=255, blank=True, null=True)
    order_conf_num = models.CharField("order confirmation number", max_length=64, blank=True, null=True)
