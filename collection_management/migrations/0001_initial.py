# Generated by Django 2.2.7 on 2020-01-27 15:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('approval_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='cellline_approval_user', to=settings.AUTH_USER_MODEL)),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cellline_createdby_user', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_formz_gentech_methods', models.TextField(blank=True, verbose_name='genTech methods')),
                ('history_formz_elements', models.TextField(blank=True, verbose_name='formz elements')),
                ('approval_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='coli_approval_user', to=settings.AUTH_USER_MODEL)),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='coli_createdby_user', to=settings.AUTH_USER_MODEL)),
                ('formz_elements', models.ManyToManyField(blank=True, related_name='coli_formz_element', to='formz.FormZBaseElement', verbose_name='elements')),
                ('formz_projects', models.ManyToManyField(related_name='coli_formz_project', to='formz.FormZProject', verbose_name='formZ projects')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('approval_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='plasmid_approval_user', to=settings.AUTH_USER_MODEL)),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='plasmid_createdby_user', to=settings.AUTH_USER_MODEL)),
                ('formz_ecoli_strains', models.ManyToManyField(related_name='plasmid_ecoli_strains', to='collection_management.EColiStrain', verbose_name='e. coli strains')),
                ('formz_elements', models.ManyToManyField(blank=True, help_text='<a href="/formz/formzbaseelement/" target="_blank">View all/Change</a>', to='formz.FormZBaseElement', verbose_name='elements')),
                ('formz_gentech_methods', models.ManyToManyField(blank=True, help_text='The methods used to create the plasmid', related_name='plasmid_gentech_method', to='formz.GenTechMethod', verbose_name='genTech methods')),
                ('formz_projects', models.ManyToManyField(related_name='plasmid_formz_projects', to='formz.FormZProject', verbose_name='projects')),
                ('parent_vector', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='plasmid_parent_vector', to='collection_management.Plasmid', verbose_name='parent vector')),
                ('vector_zkbs', models.ForeignKey(help_text='The backbone of the plasmid, from the ZKBS database. If not applicable, choose none. <a href="/formz/zkbsplasmid/" target="_blank">View all</a>', null=True, on_delete=django.db.models.deletion.PROTECT, to='formz.ZkbsPlasmid', verbose_name='ZKBS database vector')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_formz_gentech_methods', models.TextField(blank=True, verbose_name='genTech methods')),
                ('history_formz_elements', models.TextField(blank=True, verbose_name='formz elements')),
                ('approval_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='cerevisiae_approval_user', to=settings.AUTH_USER_MODEL)),
                ('cassette_plasmids', models.ManyToManyField(blank=True, help_text='Tagging and knock out plasmids', related_name='cerevisiae_cassette_plasmids', to='collection_management.Plasmid')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cerevisiae_createdby_user', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_formz_gentech_methods', models.TextField(blank=True, verbose_name='genTech methods')),
                ('history_formz_elements', models.TextField(blank=True, verbose_name='formz elements')),
                ('approval_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='pombe_approval_user', to=settings.AUTH_USER_MODEL)),
                ('cassette_plasmids', models.ManyToManyField(blank=True, help_text='Tagging and knock out plasmids', related_name='pombe_cassette_plasmids', to='collection_management.Plasmid')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='pombe_createdby_user', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plasmid', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='collection_management.Plasmid', verbose_name='Plasmid')),
                ('scpombe_strain', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='collection_management.ScPombeStrain')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateField(blank=True, null=True, verbose_name='created')),
                ('destroyed_date', models.DateField(blank=True, null=True, verbose_name='destroyed')),
                ('formz_projects', models.ManyToManyField(blank=True, related_name='cerevisiae_episomal_plasmid_projects', to='formz.FormZProject')),
                ('plasmid', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='collection_management.Plasmid', verbose_name='Plasmid')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_changed_approval_by_pi', models.NullBooleanField(default=None, verbose_name='record change approval')),
                ('approval_by_pi_date_time', models.DateTimeField(default=None, null=True)),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='oligo_createdby_user', to=settings.AUTH_USER_MODEL)),
            ],
            bases=(models.Model, collection_management.models.SaveWithoutHistoricalRecord),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_1', models.ForeignKey(blank=True, db_constraint=False, help_text='Main parental strain', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='collection_management.ScPombeStrain', verbose_name='Parent 1')),
                ('parent_2', models.ForeignKey(blank=True, db_constraint=False, help_text='Only for crosses', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='collection_management.ScPombeStrain', verbose_name='Parent 2')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('parent_1', models.ForeignKey(blank=True, db_constraint=False, help_text='Main parental strain', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='collection_management.SaCerevisiaeStrain', verbose_name='Parent 1')),
                ('parent_2', models.ForeignKey(blank=True, db_constraint=False, help_text='Only for crosses', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='collection_management.SaCerevisiaeStrain', verbose_name='Parent 2')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('parent_vector', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='collection_management.Plasmid', verbose_name='parent vector')),
                ('vector_zkbs', models.ForeignKey(blank=True, db_constraint=False, help_text='The backbone of the plasmid, from the ZKBS database. If not applicable, choose none. <a href="/formz/zkbsplasmid/" target="_blank">View all</a>', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='formz.ZkbsPlasmid', verbose_name='ZKBS database vector')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('organism', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='formz.Species', verbose_name='organism')),
                ('parental_line', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='collection_management.CellLine', verbose_name='parental line')),
                ('zkbs_cell_line', models.ForeignKey(blank=True, db_constraint=False, help_text='If not applicable, choose none. <a href="/formz/zkbscellline/" target="_blank">View all</a>', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='formz.ZkbsCellLine', verbose_name='ZKBS database cell line')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('destroyed_date', models.DateField(blank=True, null=True, verbose_name='destroyed')),
                ('cell_line', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='collection_management.CellLine')),
                ('formz_projects', models.ManyToManyField(blank=True, related_name='cellline_episomal_plasmid_projects', to='formz.FormZProject')),
                ('plasmid', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='collection_management.Plasmid', verbose_name='Plasmid')),
            ],
        ),
        migrations.CreateModel(
